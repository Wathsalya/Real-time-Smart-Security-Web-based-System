...
"""
Running HornSchunck.py frame1.jpeg frame2.jpeg
"""
...
def computeHS(name1, name2, alpha, delta):
    ...
    while True:
        ...
        diff = np.linalg.norm(u - prev, 2)#This function is able to return one of eight different matrix norms, or one of an infinite number of vector norms (described below), depending on the value of the ord parameter.
...
if __name__ == '__main__':
    ...
    u,v = computeHS(args.img1, args.img2, alpha = 15, delta = 3)
